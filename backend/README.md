...
## Project Structure
    ...
    ├── fragrant_butterfly_102291  # Django project configurations
...
1. Clone this repo and `cd fragrant_butterfly_102291`
...
2. Clone this repo and `cd fragrant_butterfly_102291`
